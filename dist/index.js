...
export function catppuccinTheme(variant) {
    ...
    return EditorView.theme({
        ...
        '&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection': { backgroundColor: selectionBg },
...
export function catppuccinHighlightStyle(variant) {
    ...
    return HighlightStyle.define([
        ...
        { tag: t.operatorKeyword, color: palette.flamingo.hex },
        { tag: t.controlKeyword, color: palette.sapphire.hex, fontWeight: 'bold' },
        { tag: t.definitionKeyword, color: palette.yellow.hex },
        ...
        { tag: t.local(t.name), color: palette.flamingo.hex },
...
/// the highlight style).
export function catppuccin(variant) {
